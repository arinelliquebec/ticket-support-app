...
export function ValidatedTicketForm({
  ticket,
  categories = [],
  ...
  // Função para verificar se há erros no cliente
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateField("categoryId", value === "none" ? null : value)
                }
              >
                <SelectTrigger
                  id="categoryId"
            ...
            <div className="space-y-2">
              ...
              <Select
                name="filial"
                value={formValues.filial === null ? "none" : formValues.filial}
                onValueChange={(value) =>
                  updateField("filial", value === "none" ? null : value)
                }
              >
                <SelectTrigger
                  id="filial"
