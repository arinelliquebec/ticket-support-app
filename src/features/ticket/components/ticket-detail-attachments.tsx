...
type TicketDetailAttachmentsProps = {
  ticketId: string;
  isDetail?: boolean;
};

export const TicketDetailAttachments = ({
  ticketId,
  isDetail = true,
}: TicketDetailAttachmentsProps) => {
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8 border-2 border-dashed rounded-lg border-muted/30">
                ...
                <p className="text-muted-foreground">
                  Nenhum anexo vinculado ao ticket
                </p>
                <p className="text-xs text-muted-foreground mt-1">
                  Envie arquivos para este ticket clicando no botão de upload
                  acima.
                </p>
              </div>
            ) : (
